      ...
      <div class="card  offset-2" style="width: 24rem;" >
          <div class="card-body">
              <div class="card-img-top">
                  <img src="Images/profile.jpg" class="card-img-top" alt="..." width="12rem">
              </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <form action="uploadProfile" method="post">
                              <b>Upload the profile pic :</b><input type="file" name="file"><br><br>
      ...
      <table class="table" width="150px" height="500" style="margin-top:50px">
        ...
        <div id="attendance-main">
           ...
           <%
            ...
            ResultSet total_classes=null;
            ResultSet present_classes=null;
           ...
           <table class="mt-3"  cellpadding="5">
               ...
               <%
                   ...
                   try{
                        ...
                        result=st.executeQuery("select * from r19_attendance where id='"+user+"' and os!='null';");
                        
                        total_classes=st1.executeQuery("select count(*) from r19_attendance where id='"+user+"' and os!='null';" );
                        present_classes=st2.executeQuery("select count(*) from r19_attendance where os='present' and id='"+user+"'");
                        
                       
                        total_classes.next();
                        classes_count=total_classes.getInt(1);
                        
                        present_classes.next();
                        present_count=present_classes.getInt(1);
                        
                        percentage=(float)present_count/classes_count*100;
                        while(result.next()){%>
                            <tr>
                                <td><%out.println(result.getString("date"));%></td>
                                <td><%out.println(result.getString("os"));%></td>
               ...
               %>
               <tr>
                   <th colspan="2"> Total classes: <% out.println(classes_count); %> <th>
               </tr> 
                <tr>
                   <th colspan="2"> Attended classes:  <% out.println(present_count); %> <th>
               </tr>               
                <tr>
                   <th colspan="2"> percentage:  <% out.println(percentage); %> <th>
               </tr>
           </table>
           ...
           <table class="mt-3"  cellpadding="5">
               ...
               <%
                   ...
                   try{
                       result=st.executeQuery("select * from r19_attendance where id='"+user+"' and se!='null';");
                        
                        total_classes=st1.executeQuery("select count(*) from r19_attendance where id='"+user+"' and se!='null';");
                        present_classes=st2.executeQuery("select count(*) from r19_attendance where se='present' and id='"+user+"'");
                        ...
                        while(result.next()){%>
                            <tr>
                                <td><%out.println(result.getString("date"));%></td>
                                <td><%out.println(result.getString("se"));%></td>
           ...
           <table class="mt-3"  cellpadding="5">
               ...
               <%
                   ...
                   try{
                        result=st.executeQuery("select * from r19_attendance where id='"+user+"' and cn!='null';");
                        
                        total_classes=st1.executeQuery("select count(*) from r19_attendance where id='"+user+"' and cn!='null';");
                        present_classes=st2.executeQuery("select count(*) from r19_attendance where cn='present' and id='"+user+"'");
                        ...
                        while(result.next()){%>
                            <tr>
                                <td><%out.println(result.getString("date"));%></td>
                                <td><%out.println(result.getString("cn"));%></td>
        ...
        <table class="mt-3"  cellpadding="5">
               ...
               <%
                   ...
                   try{
                        result=st.executeQuery("select * from r19_attendance where id='"+user+"' and dm!='null';");
                        
                        total_classes=st1.executeQuery("select count(*) from r19_attendance where id='"+user+"' and dm!='null';");
                        present_classes=st2.executeQuery("select count(*) from r19_attendance where dm='present' and id='"+user+"'");
                        ...
                        while(result.next()){%>
                            <tr>
                                <td><%out.println(result.getString("date"));%></td>
                                <td><%out.println(result.getString("dm"));%></td>
           ...
           <table class="mt-3"  cellpadding="5">
               <tr>
                   <th colspan="2">MFDS ATTENDANCE<th>
               ...
               <%
                   ...
                   try{
                       result=st.executeQuery("select * from r19_attendance where id='"+user+"' and mfds!='null';");
                        
                        total_classes=st1.executeQuery("select count(*) from r19_attendance where id='"+user+"' and mfds!='null';");
                        present_classes=st2.executeQuery("select count(*) from r19_attendance where dm='present' and id='"+user+"'");
           ...
           <table class="mt-3"  cellpadding="5">
               <tr>
                   <th colspan="2">OS_LAB ATTENDANCE<th>
               ...
               <%
                   ...
                   try{
                       result=st.executeQuery("select * from r19_attendance where id='"+user+"' and os_lab!='null';");
                        
                        total_classes=st1.executeQuery("select count(*) from r19_attendance where id='"+user+"' and os_lab!='null';");
                        present_classes=st2.executeQuery("select count(*) from r19_attendance where os_lab='present' and id='"+user+"'");
                        ...
                        while(result.next()){%>
                            <tr>
                                <td><%out.println(result.getString("date"));%></td>
                                <td><%out.println(result.getString("os_lab"));%></td>
           ...
           <table class="mt-3"  cellpadding="5">
               <tr>
                   <th colspan="2">SE_LAB ATTENDANCE<th>
               ...
               <%
                   ...
                   try{
                        result=st.executeQuery("select * from r19_attendance where id='"+user+"' and se_lab!='null';");
                        
                        total_classes=st1.executeQuery("select count(*) from r19_attendance where id='"+user+"' and se_lab!='null';");
                        present_classes=st2.executeQuery("select count(*) from r19_attendance where se_lab='present' and id='"+user+"'");
                        ...
                        while(result.next()){%>
                            <tr>
                                <td><%out.println(result.getString("date"));%></td>
                                <td><%out.println(result.getString("se_lab"));%></td>
           ...
           <table class="mt-3"  cellpadding="5">
               <tr>
                   <th colspan="2">CN_LAB ATTENDANCE<th>
               ...
               <%
                   ...
                   try{
                        result=st.executeQuery("select * from r19_attendance where id='"+user+"' and cn_lab!='null';");
                        
                        total_classes=st1.executeQuery("select count(*) from r19_attendance where id='"+user+"' and cn_lab!='null';");
                        present_classes=st2.executeQuery("select count(*) from r19_attendance where cn_lab='present' and id='"+user+"'");
                        ...
                        while(result.next()){%>
                            <tr>
                                <td><%out.println(result.getString("date"));%></td>
                                <td><%out.println(result.getString("cn_lab"));%></td>
          ...
          <div class="card-body">
              ...
              <div class="card-img-top">
                  <img src="Images/fax-1889009_640.jpg" class="card-img-top" alt="..." width="12rem">
                    ...
                    <a href="home.html" class="btn btn-primary">Give Feedback</a>
            </div>
                    </div>
    </div>
   </div>

    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(val==null){
                ...
                String query1="select * from admission order by idnumber desc limit 1;";
                ...
                String query="insert into admission values('"+name+"','"+dob+"','"+gender+"','"+mobile+"','"+email+"','"+password+"','"+fname+"','"+mname+"','"+pcontact+"','"+occupation+"','"+village+"','"+pincode+"','"+mandal+"','"+district+"','"+state+"','"+str2+"','"+clgmail+"','"+clgpassword+"');";
